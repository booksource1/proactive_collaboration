...
class Robot:
    ...
    def __init__(
        ...
        初始化机器人状态
        :param name: 机器人名称
        :param capacity: 机器人能力（如负载能力、处理能力等）
        """
        ...
        self.moveable_objects = []  # 可以被移动的物体
        self.pickable_objects = []  # 只有 pickable object 才能被拿起来
        self.placeable_objects = []  # 只有 placeable object 才能被放下来
        self.teammates = None
